...
# A network is a weak, shared signal: venue Wi-Fi must accommodate an event
# burst. The device bucket remains the stronger control for one browser.
AUTH_RATE_LIMIT_PER_IP = _env_int("NIMHUNT_CLAIM_AUTH_RATE_LIMIT_PER_IP", 40)
