...
import { COMMON_TEXT, REPORT_REASON_OPTIONS, makeSpotDetailText } from './interface_text.js?v=claim-polish-v2-20260704';
import { appendSpotTitleWithLock, createOwnerClaimCodesControl } from './spot_ui.js?v=small-polish-v1-20260705';
...
async function requestWalletDeviceIdForReport() {
    try {
        const id = await requestDeviceIdentifier({
            reason: REPORT_TEXT.nimiqPay.deviceIdReason,
        });
