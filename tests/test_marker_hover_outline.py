...
def test_marker_shadow_and_cache_versions_are_preserved():
    ...
    assert '_ASSET_VERSION = "chevron-cache-compat-v2-20260813"' in public_html
    ...
    assert "spot_ui.js?v=chevron-cache-compat-v2-20260813" in my_spots
    assert "spot_ui.js?v=chevron-cache-compat-v2-20260813" in my_claims
